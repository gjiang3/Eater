...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "IzQja5OwW-9bDhqz_RpqAw";
	private static final String CLIENT_SECRET = "PsEqczVxRcjfN8joUWoKRaZyd9ncpmQlT5IvY4rGAbErTosK7f8SRTXeXlbrNMSs";
	...
	private JSONObject obtainAccessToken() {
		try {
			...
			// getOutput send request to server 
